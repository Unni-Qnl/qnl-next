...
import banner from "@/assets/harmony/harmony-banner.webp";
import bluredBanner from "@/assets/harmony/blured-harmony-banner.webp";
...
export default function HarmonyBanner({}: Props) {
  ...
  return (
    ...
    >
      <Navbar />
      <div className='harmony-bh-gradient h-full before:absolute before:inset-0 before:content-[""]'>
          ...
          <div className="container py-[3.121rem] md:py-[1.025rem] lg:py-[1.366rem] xl:py-[1.708rem] 2xl:py-[2.05rem] 3xl:py-[2.56rem]">
            ...
            <div className="mt-4 md:w-[25.7rem] lg:w-[34.266rem] xl:w-[42.833rem] 2xl:w-[51.4rem] 3xl:w-[64.25rem]">
              <h1 className="text-[1.5rem] md:text-[2.25rem] lg:text-[3rem] xl:text-[3.75rem] 2xl:text-[4.5rem] 3xl:text-[5.625rem] leading-snug">
                Enterprise Digital Marketing, Reimagined
              </h1>
              <p className="font-normal text-[0.75rem] md:text-[0.7rem] lg:text-[0.933rem] xl:text-[1.166rem] 2xl:text-[1.4rem] 3xl:text-[1.75rem] mt-2 md:mt-[0.8rem] lg:mt-[1.066rem] xl:mt-[1.333rem] 2xl:mt-[1.6rem] 3xl:mt-[2rem]">
                Strategic, secure, and scalable solutions for organizations
                seeking digital growth through integrated marketing, automation,
                and experience management.
              </p>
              <Button
                onClick={handleNavigate}
                className="mt-4 md:mt-[1rem] lg:mt-[1.333rem] xl:mt-[1.667rem] 2xl:mt-[2rem] 3xl:mt-[2.5rem] bg-white text-primary"
              >
                Contact Us
              </Button>
            </div>
