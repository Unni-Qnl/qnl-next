...
import sitemapBanner from "@/assets/sitemap/sitemap-banner-img.webp";
import bluredSitemapBanner from "@/assets/sitemap/blured-sitemap-banner.png";
...
export default function SitemapBanner({}: Props) {
    ...
    <div
      ...
      style={{
        backgroundImage: isVisible
          ? `url(${sitemapBanner.src})`
          : `url(${bluredSitemapBanner.src})`,
      }}
