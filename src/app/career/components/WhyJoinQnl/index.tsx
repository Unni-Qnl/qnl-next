import whyQnl from "@/assets/career/why-qnl.webp";

type Props = {};

export default function WhyJoinQnl({}: Props) {
  return (
    <div className="grid md:grid-cols-2 gap-3.5 md:gap-[2rem] lg:gap-[2.667rem] xl:gap-[3.333rem] 2xl:gap-[4rem] 3xl:gap-[5rem]">
      <div className="flex flex-col justify-center">
        ...
        <p className="text-[0.75rem] md:text-[0.7rem] lg:text-[0.933rem] xl:text-[1.167rem] 2xl:text-[1.4rem] 3xl:text-[1.75rem] mt-2 md:mt-[1rem] lg:mt-[1.333rem] xl:mt-[1.667rem] 2xl:mt-[2rem] 3xl:mt-[2.5rem]">
          QNL isn’t just a workplace — it’s where ideas turn into impact. Join a
          culture built on innovation, collaboration, and real-world
          problem-solving. We support bold thinking and value every team
          member's contributions, helping you grow while doing work that
          matters.
        </p>
      </div>
