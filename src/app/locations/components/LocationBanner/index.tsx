...
import locationBanner from "@/assets/locations/locations-banner.webp";
import bluredLocationBanner from "@/assets/locations/blured-location-banner.webp";
...
export default function LocationBanner({}: Props) {
    ...
    <div
      ...
      style={{
        backgroundImage: isVisible
          ? `url(${locationBanner.src})`
          : `url(${bluredLocationBanner.src})`,
      }}
